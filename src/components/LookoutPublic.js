...
export default class Lookoutpublic extends Component{
  constructor(props){
    super(props);
    this.state = {
      options: [],
  ...
  <div className="modal-dialog">
    <div className="modal-content">
      <div className="modal-header">
        ...
        <span className="custom-ss-public-flag">Flag Public </span><i class="custom-ss-public-flag-icon fab fa-font-awesome-flag"></i>
      </div>
      ...
      <div className="row">
        ...
        <div className="col-md-12">
          ...
          <div className="row custom-rangeslider custom-ss-publicslider">
          <div className="col-md-3">
          <p>Proficiency</p>
          </div>
          <div className="col-md-9">
